...
const Privacy = () => {
    return (
        <>
            <h2  style={{backgroundColor:'antiquewhite',textAlign:'center'}}>Privacy Statement for Medicine Store</h2><br />
            <p>
                This Prcvacy Policy describes how your personal information is collected,
                used, and shared when you visit or make a purchase from medicinestore.com (the
                &quot;Site&quot;).
            </p>
            <hr></hr>
            <h2  style={{backgroundColor:'antiquewhite',textAlign:'center'}}>Personal information we collect</h2>
            <br />
            <p>
                ...
                as you browse the Site, we collect information about the individual web pages or
            ...
            <ul>
                ...
                <li>
                    &quot;Log files&quot;, and User Accounts, track actions occurring on the Site, and
            ...
            <hr></hr>
            <h2  style={{backgroundColor:'antiquewhite',textAlign:'center'}}>Personal User Information</h2>
            <br />
            <p>
            ...
            <p>
                We use your account information that we collect generally to generate
                statistics for you, and provide personalized roadmaps. Additionally, we use this
                information to:
            </p>
            <ul>
                <li>Communicate with you;</li>
            ...
            <p>
                We also use Shopify to power our online store--you can read more about how
            ...
            <p>
                We fund our site by showing adverts as you browse our site.  These adverts are usually managed by a partner
                specializing in providing adverts for multiple sites.  Invariably these partners collect anonymous data about the websites you visits so they can
                personalize the adverts to you, ensure that you don't see the same adverts too frequently and ultimately report to advertisers on which adverts are working.  We use a third-party to provide monetization technologies for our site. You can review their
                <a href="https://www.snigel.com/privacy-policy/" target="_blank">privacy and cookie policy here</a>.
            </p>
            <p>
            ...
            <hr></hr>
            <h2  style={{backgroundColor:'antiquewhite',textAlign:'center'}}>Behavioural advertising </h2>
            <br />
            <p>
            ...
            <p>You can get a full list of the partners we use by accessing our ads.txt file.</p>
            <p>
            ...
            <p>
                You can learn more about online advertising, or opt-out of almost all
                advertising cookies at <a target="_blank" href="https://www.youronlinechoices.com">https://www.youronlinechoices.com</a>.
            </p>
            <p>
                <strong>Note:</strong> Opting out will not disable ads,
                they will just no longer be tailored to you.
            </p>
            <hr></hr>
            <h2  style={{backgroundColor:'antiquewhite',textAlign:'center'}}>Manage Consent</h2>
            <br />
            <p>If you want to change your choices regarding your personal information, you can use the button below:</p>
            <p><button class="ws-btn" onclick='adconsent("showGUI")'>Manage Consent</button></p>
            <hr></hr>
            <h2  style={{backgroundColor:'antiquewhite',textAlign:'center'}}>Do not track</h2>
            <br />
            <p>
            ...
            <hr></hr>
            <h2  style={{backgroundColor:'antiquewhite',textAlign:'center'}}> Your rights</h2>
            <br />
            <p>
            ...
            <hr></hr>
            <h2  style={{backgroundColor:'antiquewhite',textAlign:'center'}}>Data retention</h2>
            <br />
            <p>
            ...
            <hr></hr>
            <h2  style={{backgroundColor:'antiquewhite',textAlign:'center'}}>Changes</h2>
            <br />
            <p>
            ...
            <hr></hr>
            <h2  style={{backgroundColor:'antiquewhite',textAlign:'center'}}>Using Google Drive in our Tryit Editor</h2>
            <br />
            <p>
                Our Tryit Editor allows users to store code to, or import code from, Google
                Drive.
            </p>
            ...
            <p>
                W3Schools does not keep for ourselves, or share this information with third
                parties.
            </p>
            <hr></hr>
            <h2  style={{backgroundColor:'antiquewhite',textAlign:'center'}}>Links</h2>
            <br />
            <p>
                Laptop Store contains links to other sites. We are not responsible for the privacy practices or the content of such Web sites.
                This privacy document applies only to Laptop Store.
            </p>
            <hr></hr>
            <h2  style={{backgroundColor:'antiquewhite',textAlign:'center'}}>Contact us</h2>
            <br />
            <p>
                ...
                help@w3schools.com or by mail using the details provided below:
            </p>
            <p>
                Medicine store <br></br>[Re: Privacy Compliance Officer] <br></br>Larsamyraa 18, 4313
                SANDNES, Norway
            </p>
        </>
    )
